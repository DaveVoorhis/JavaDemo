...
public class Demo {
	...
	public static void main(String[] args) {
		...
		*/
		...
		List<Person> peopleToPickFrom =
			sales.stream().
			collect(Collectors.groupingBy(sale -> sale.getPerson(), Collectors.summingDouble(sale -> sale.getAmount()))).
			entrySet().stream().
			filter(sale -> sale.getValue() > 20.0 || sale.getKey().getAge() < 18).
